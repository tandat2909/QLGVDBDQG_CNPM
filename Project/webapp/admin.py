...
admin.add_view(ModelView(models.TeamsInRound, db.session))
admin.add_view(ModelView(models.Position, db.session))
admin.add_view(ModelView(models.Config, db.session))
admin.add_view(ModelView(models.Match, db.session))
admin.add_view(ModelView(models.Player, db.session))
admin.add_view(ModelView(models.Goal, db.session))
admin.add_view(ModelView(models.TypeGoals, db.session))
admin.add_view(ModelView(models.PrioritySort, db.session))
